...
namespace KioscoInformaticoBackend.Migrations
{
    ...
    public partial class InicioProyecto : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Productos",
                columns: new[] { "Id", "Eliminado", "Imagen", "Nombre", "Oferta", "Precio" },
                values: new object[,]
                {
                    { 1, false, null, "Coca-Cola 2lts", false, 2500m },
                    { 2, false, null, "Papas Lays 160grs", false, 1500m },
                    { 3, false, null, "Agua Mineral 2lts", false, 2000m }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "0000003100010000000001", 5, "Calle 1", false, 1, "Proveedor A", "111111111" },
                    ...
                    { 4, "0000003100010000000004", 3, "Calle 4", false, 1, "Proveedor D", "444444444" },
                    { 5, "0000003100010000000005", 4, "Calle 5", false, 1, "Proveedor E", "555555555" },
                    { 6, "0000003100010000000006", 5, "Calle 6", false, 2, "Proveedor F", "666666666" },
                    { 7, "0000003100010000000007", 3, "Calle 7", false, 3, "Proveedor G", "777777777" },
                    { 8, "0000003100010000000008", 5, "Calle 8", false, 2, "Proveedor H", "888888888" },
                    { 9, "0000003100010000000009", 6, "Calle 9", false, 3, "Proveedor I", "999999999" },
                    { 10, "0000003100010000000010", 3, "Calle 10", false, 3, "Proveedor J", "101010101" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, false, new DateTime(2021, 5, 15, 0, 0, 0, 0, DateTimeKind.Unspecified), 0, 21m, 1, 1000m },
                    { 2, false, new DateTime(2021, 5, 16, 0, 0, 0, 0, DateTimeKind.Unspecified), 1, 10m, 2, 2000m },
                    { 3, false, new DateTime(2021, 5, 17, 0, 0, 0, 0, DateTimeKind.Unspecified), 2, 5m, 3, 3000m },
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, false, new DateTime(2024, 11, 13, 16, 51, 20, 8, DateTimeKind.Local).AddTicks(5951), 0, 21m, 3000m },
                    { 2, 2, false, new DateTime(2024, 11, 13, 16, 51, 20, 8, DateTimeKind.Local).AddTicks(5977), 1, 10m, 5000m },
                    { 3, 1, false, new DateTime(2024, 11, 13, 16, 51, 20, 8, DateTimeKind.Local).AddTicks(5980), 2, 21m, 8000m }
                });
